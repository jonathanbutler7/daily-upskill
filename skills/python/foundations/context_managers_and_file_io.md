# SKILL: Efficient Data Handling (Context Managers & File I/O)

**When to use**: Reading and writing large datasets from local or remote storage, ensuring system resources (like file handles) are properly released even if an error occurs.
