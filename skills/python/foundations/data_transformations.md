# SKILL: Practical Data Transformations (Comprehensions & Generators)

**When to use**: Cleaning, filtering, or transforming small to medium datasets in memory before passing them to a model or pipeline.
