# CONCEPT: Functional Patterns for Data Pipelines (map, filter, reduce)

> **Related Exercise**: `exercises/functional_patterns_260325.py`

## When to Use

Building data cleaning or transformation pipelines where you want to chain operations together in a clear, functional way.
