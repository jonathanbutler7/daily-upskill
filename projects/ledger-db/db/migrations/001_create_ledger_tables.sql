...
create table ledger_accounts (
    ...
    normal_balance text not null check(normal_balance in ('credit', 'debit')),
    ledgerable_type text not null check(ledgerable_type in ('external_account', 'internal_account')),
